...
def crea_anagrafica():
    ...
    df.to_csv('anagrafica.csv', index=False, sep=';', header=False, mode='w')
...
def optionmenu_callback(value):
    ...
    match CAMPO_CORRENTE:
        case 0:
            ...
            COLONNE_ANACD.append(value)
        case 1:
            text = label_testo_anagrafica.cget("text")
            label_testo_anagrafica.configure(text=text + ' ' + value)
            COLONNE_ANADN.append(value)
        case 2:
            text = label_testo_anagrafica.cget("text")
            label_testo_anagrafica.configure(text=text + ' ' + value)
            COLONNE_ANAPARENT.append(value)
        case 3:
            text = label_testo_anagrafica.cget("text")
            label_testo_anagrafica.configure(text=text + ' ' + value)
            COLONNE_ANADS.append(value)
        case 4:
            text = label_testo_anagrafica.cget("text")
            label_testo_anagrafica.configure(text=text + ' ' + value)
            COLONNE_ANANOTE.append(value)
